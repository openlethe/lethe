...
export default definePluginEntry({
    ...
    configSchema: {
        ...
        jsonSchema: {
            ...
            properties: {
                endpoint: {
                    type: "string",
                    description: "Lethe server endpoint (e.g. http://localhost:18483)",
    ...
    register(api) {
        ...
        api.registerContextEngine("mentholmike-lethe", () => new LetheContextEngine({ endpoint, apiKey, agentId, projectId }));
